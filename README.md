...
ส่วน `diaries/reviews/` คือ **retrospective** — บททบทวนข้ามวันที่เขียนทุกหลายเซสชัน (ไม่ใช่ทุกวัน) แยก genre ออกจากไดอารี่รายวันเพื่อไม่ให้บันทึกกลายเป็นการส่องตัวเองวนซ้ำ
